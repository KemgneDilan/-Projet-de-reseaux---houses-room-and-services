...
export const listings = [
  ...
  },
  {
    ...
    description: 'Respirez l\'air frais du Mont Cameroun dans notre gîte d\'étape convivial. Idéal pour les randonneurs voulant échanger, partager des histoires et déguster un repas chaud cuisiné ensemble au feu de bois après l\'ascension.',
    price: 9000,
    currency: 'XAF',
    rating: 4.9,
    reviewsCount: 56,
